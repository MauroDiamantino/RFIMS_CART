...
//! The class _RFPloter_ is intended to plot sweeps, RF interference (RFI) and any frequency curve.
...
{
	//Class' attributes//
	Gnuplot ploter; //!< An object which represent an interface to the software \em gnuplot.
...
#ifdef DEBUG
	RFPloter auxRFPloter; //!< This plotter is intended to see internal steps of the calibration process of a given sweep.
#endif
	//Private methods//
