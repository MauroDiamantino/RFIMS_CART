...
\end{tabbing}\begin{DoxyCompactList}\small\item\em This structure is intended to store the assignment of G\+P\+IO pins to input and output external signals, taking into account the Wiring Pi numbering. \end{DoxyCompactList}\end{DoxyCompactItemize}
