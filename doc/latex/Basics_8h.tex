...
struct \{\\
\>const unsigned int \hyperlink{Basics_8h_a88cf59242b5a2ace3d90704ab4d2bcda}{SWITCH} = 8\\
\>\>{\em This pin is initialized as an output in LOW state, so the RF switch output will start connected to the noise source. }\\
\>const unsigned int \hyperlink{Basics_8h_ac49574191d7b969a384f488bf156f074}{NOISE\_SOURCE} = 13\\
\>\>{\em This pin is initialized as an output in LOW state, so the noise source will start turned off. }\\
\>const unsigned int \hyperlink{Basics_8h_a3082ce7a3469a197735f0df330c1db7f}{LNAS} = 12\\
\>\>{\em This pin is initialized as an output in LOW state, so the LNAs will start turned off. }\\
\>const unsigned int \hyperlink{Basics_8h_a237073109a5bfa275095a6997d994c39}{SPECTRAN} = 14\\
\>\>{\em This pin is initialized as an input with the pull-\/down resistor enabled, so the Spectran device will start turned off. }\\
\>const unsigned int \hyperlink{Basics_8h_a1f3aea83acb94fb9385c520e133172cc}{LED\_SWEEP\_CAPTURE} = 9\\
\>\>{\em This pin is initialized as an output in LOW state, so the led will start turned off. }\\
\>const unsigned int \hyperlink{Basics_8h_ad2b6181fa6a423c60c574fa713cbe6cd}{LED\_SWEEP\_PROCESS} = 10\\
\>\>{\em This pin is initialized as an output in LOW state, so the led will start turned off. }\\
\>const unsigned int \hyperlink{Basics_8h_a2b7714e3fe4c2724a3954fedefe07d39}{LED\_INIT\_POS} = 1\\
\>\>{\em This pin is initialized as an output in LOW state, so the led will start turned off. }\\
\>const unsigned int \hyperlink{Basics_8h_af304626609da54cf58c8e0a46dac817c}{LED\_NEXT\_POS} = 3\\
\>\>{\em This pin is initialized as an output in LOW state, so the led will start turned off. }\\
\>const unsigned int \hyperlink{Basics_8h_a916b908a0652e7d442ecf8f1383a6b5f}{LED\_POLARIZ} = 5\\
\>\>{\em This pin is initialized as an output in LOW state, so the led will start turned off. }\\
\>const unsigned int \hyperlink{Basics_8h_a95f3adabd348cd13ff295c9edce98d38}{BUTTON\_ENTER} = 2\\
...
\end{tabbing}\begin{DoxyCompactList}\small\item\em This unnamed structure is intended to store the constants with the assignment of G\+P\+IO pins to input and output external signals. \end{DoxyCompactList}\item 
\mbox{\Hypertarget{Basics_8h_adb83e5ae147752bdfbfec131998b1b41}\label{Basics_8h_adb83e5ae147752bdfbfec131998b1b41}} 
const int \hyperlink{Basics_8h_adb83e5ae147752bdfbfec131998b1b41}{S\+W\+I\+T\+C\+H\+\_\+\+T\+O\+\_\+\+NS} = L\+OW
\begin{DoxyCompactList}\small\item\em This constant define the value the switch\textquotesingle{}s pin must take to connect noise source to input, provided that the noise source is connected to switch\textquotesingle{}s J2 connector. \end{DoxyCompactList}\item 
\mbox{\Hypertarget{Basics_8h_a56077ad545aede44679ea2a7ab3a4d6f}\label{Basics_8h_a56077ad545aede44679ea2a7ab3a4d6f}} 
const int \hyperlink{Basics_8h_a56077ad545aede44679ea2a7ab3a4d6f}{S\+W\+I\+T\+C\+H\+\_\+\+T\+O\+\_\+\+A\+N\+T\+E\+N\+NA} = H\+I\+GH
\begin{DoxyCompactList}\small\item\em This constant define the value the switch\textquotesingle{}s pin must take to connect antenna to input, provided that the antenna is connected to switch\textquotesingle{}s J1 connector. \end{DoxyCompactList}\item 
