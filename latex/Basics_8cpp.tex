\hypertarget{Basics_8cpp}{}\section{Basics.\+cpp File Reference}
\label{Basics_8cpp}\index{Basics.\+cpp@{Basics.\+cpp}}
...
\begin{DoxyCompactList}\small\item\em Function to compare vectors containing floating-\/point numbers, taking into account the rounding errors. \end{DoxyCompactList}\item 
...
std\+::vector$<$ float $>$ \hyperlink{Basics_8cpp_ac744212c600f3f610807ec4add576822}{operator-\/} (const std\+::vector$<$ float $>$ \&vect)
