/*! \file TimeData.cpp
 * 	\brief This file contains the definitions of several methods of the structure _TimeData_.
...
void TimeData::SetTimestamp(const std::string & timestamp)
{
	...
	if( delimiterPos==std::string::npos )
		throw rfims_exception("the timestamp has an unexpected format.");
	else
	{
...
void TimeData::TurnBackDays(const unsigned int days)
{
