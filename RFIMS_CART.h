...
struct FreqValues
{
	...
	friend FreqValues operator+(const FreqValues & lhs, const std::vector<float> & rhs); //defined in FreqValues.cpp
	friend FreqValues operator+(const std::vector<float> & lhs, const FreqValues & rhs); //defined in FreqValues.cpp
...
struct BandParameters
{
	...
	unsigned long int sweepTime; //!< Time to sweep the given span, expresed in ms.
